...
public class UserTests {
    ...
    public void buildWithAddressTest() {
        User user = testBuilder.build();
        assertTrue(new ReflectionEquals(Location.covertAddressStringToLocation("4,Rountree Street,Christchurch,New Zealand,Canterbury,8041")).matches(user.getAddress()));
    }
