Feature: User
    ...
    Scenario: Create a user account
        ...
        And their date of birth is "17/7/1999"
        ...
        Then the user has the address "69 Riccarton Road, Christchurch, Canterbury, New Zealand, 8041"
    ...
    Scenario: Create a second user account
        ...
        And their date of birth is "1/3/1998"
        ...
        Then the user has the date of birth "1/3/1998"
        Then the user has the phone number "0279876543"
        Then the user has the address "100 Ocean View Crescent, Auckland, Rakino Island, New Zealand, 1010"