...
describe('SearchBusinessResults.vue', () => {
  // Container for the SearchBusinessResults under test
  let wrapper: Wrapper<any>;

  /**
   * Creates the wrapper for the SearchBusinessResults component.
   * This must be called before using the SearchBusinessResults wrapper.
   */
  function createWrapper() {
    wrapper = mount(SearchBusinessResults, {
